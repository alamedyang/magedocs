import{_ as s,o as a,c as n,a as o}from"./app-oGoBbKgC.js";const l={},p=o(`<h1 id="serial-dialog-options-json" tabindex="-1"><a class="header-anchor" href="#serial-dialog-options-json" aria-hidden="true">#</a> Serial Dialog Options (JSON)</h1><p>For the <a href="../mgs/mgs_natlang">MGS Natlang</a> equivalent, see <a href="../mgs/serial_dialog_options_mgs">Serial Dialog Options (MGS)</a>.</p><h2 id="multiple-choice" tabindex="-1"><a class="header-anchor" href="#multiple-choice" aria-hidden="true">#</a> Multiple Choice</h2><p>In the <a href="../dialogs/serial_dialogs_json">entry for a serial dialog</a>, you can include a second property named <code>options</code>.</p><div class="language-json" data-ext="json"><pre class="shiki dark-plus" style="background-color:#1E1E1E;" tabindex="0"><code><span class="line"><span style="color:#D4D4D4;">{</span></span>
