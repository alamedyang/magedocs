import{_ as o,r as l,o as e,c as p,b as t,d as s,e as c,w as r,a}from"./app-MrF-XoWp.js";const D={},i=a(`<h1 id="serial-dialog-options-json" tabindex="-1"><a class="header-anchor" href="#serial-dialog-options-json" aria-hidden="true">#</a> Serial Dialog Options (JSON)</h1><p>For the <a href="../mgs/mgs_natlang">MGS Natlang</a> equivalent, see <a href="../mgs/serial_dialog_options_mgs">Serial Dialog Options (MGS)</a>.</p><h2 id="multiple-choice" tabindex="-1"><a class="header-anchor" href="#multiple-choice" aria-hidden="true">#</a> Multiple Choice</h2><p>In the <a href="../dialogs/serial_dialogs_json">entry for a serial dialog</a>, you can include a second property named <code>options</code>.</p><div class="language-json" data-ext="json"><pre class="shiki dark-plus" style="background-color:#1E1E1E;" tabindex="0"><code><span class="line"><span style="color:#D4D4D4;">{</span></span>
...
<span class="line"><span style="color:#D4D4D4;">  }</span></span>
<span class="line"><span style="color:#D4D4D4;">}</span></span>
<span class="line"></span></code></pre></div>`,5),y=a(`<div class="language-text" data-ext="text"><pre class="shiki dark-plus" style="background-color:#1E1E1E;" tabindex="0"><code><span class="line"><span style="color:#D4D4D4;">What&#39;s your name?</span></span>
<span class="line"><span style="color:#D4D4D4;"></span></span>
...
<span class="line"><span style="color:#D4D4D4;">  }</span></span>
<span class="line"><span style="color:#D4D4D4;">}</span></span>
<span class="line"></span></code></pre></div>`,5);function u(d,h){const n=l("RouterLink");return e(),p("div",null,[i,t("p",null,[s("These will appear in the "),c(n,{to:"/terminal.html"},{default:r(()=>[s("terminal")]),_:1}),s(" as numbered options.")]),y])}const C=o(D,[["render",u],["__file","serial_dialog_options_json.html.vue"]]);export{C as default};
