import{_ as s,o as a,c as n,a as e}from"./app-j-XjLWpf.js";const o={},l=e(`<h1 id="serial-dialogs" tabindex="-1"><a class="header-anchor" href="#serial-dialogs" aria-hidden="true">#</a> Serial Dialogs</h1><p><strong>Serial dialogs</strong> are a means to print messages on the serial <a href="terminal">terminal</a> (new as of the chapter 2 version of the MGE).</p><p>They need not function as <a href="entities">character</a> <a href="dialogs">dialog</a>, strictly speaking; they can be anything, including <a href="debug_tools#debug-scripting">debug messages</a>, ASCII maps, room or character descriptions, etc.</p><p>Serial dialogs do nothing on their own. To show them, you must use the <a href="actions/SHOW_SERIAL_DIALOG">SHOW_SERIAL_DIALOG</a> action within a <a href="scripts">script</a>.</p><p>Serial dialog names must be unique throughout the entire game project. (<a href="mgs/mgs_natlang">MGS Natlang</a> will auto generate dialog names when they are not declared.)</p><h2 id="properties" tabindex="-1"><a class="header-anchor" href="#properties" aria-hidden="true">#</a> Properties</h2><p>The only required serial dialog property is <code>messages</code>, though there are two types of dialog options: multiple choice and free response.</p><p>Serial dialog messages are not auto wrapped unless handled by <a href="mgs/mgs_natlang">MGS Natlang</a>.</p><h2 id="json-structure" tabindex="-1"><a class="header-anchor" href="#json-structure" aria-hidden="true">#</a> JSON Structure</h2><div class="custom-container warning"><p class="custom-container-title">Slightly Deprecated</p><p>With the introduction of <a href="mgs/mgs_natlang">MGS Natlang</a>, you need not write serial dialogs with JSON, but it still may be useful to understand the JSON structure for debugging purposes.</p></div><div class="language-json" data-ext="json"><pre class="shiki dark-plus" style="background-color:#1E1E1E;" tabindex="0"><code><span class="line"><span style="color:#D4D4D4;">{</span></span>
