...
- Script definitions and other [[syntax_scopes#Project Scope|project-scoped]] structures will also be brought over, and these will count as duplicate definitions. Therefore, included files should only have MGS-only features, like [[dialog_and_serial_dialog_settings|dialog and serial dialog settings]] and [[fns|fns]].
...
- Fns are [[syntax_scopes#File Scope|file scope]] (cannot be redefined or used before definition), and scripts are [[syntax_scopes#Project Scope|project scope]] (always exist and are always accessible globally).
