...
- Bools and ints cannot be converted into strings. (No `.toString()`!)
	- Exception: the current value of an int may be [[dialog_and_serial_dialog_strings#Print Variable Value|printed]] as part of a [[dialog_and_serial_dialog_strings|dialog or serial dialog string]].
