...
Unlike with [[dialog_and_serial_dialog_strings|dialog and serial dialog message strings]], the value of the constant is baked into the string at the moment of definition, because both template strings and constants are [file scope](syntax_scopes#file-scope) and do not exist in the final game state.
